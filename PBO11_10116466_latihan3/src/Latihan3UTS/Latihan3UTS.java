 ...
 * @author user
 */
public class Latihan3UTS extends javax.swing.JFrame {

    /**
     * Creates new form Latihan3UTS
     */
    public Latihan3UTS() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("APLIKASI PENDATAAN PENDATAAN VOLUNTER DEV SUMMIT");
        ...
        cbJurusan.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "TEKNIK INFORMTIKA", "ILMU KOMUNIKASI", "ILMU HUKUM", "DESAIN KOMUNIKASI VISUAL" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Latihan3UTS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Latihan3UTS().setVisible(true);
            }
        });
    }
